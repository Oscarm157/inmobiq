...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: https://*.mapbox.com https://lh3.googleusercontent.com https://*.supabase.co https://*.googleusercontent.com https://*.mlstatic.com https://img.inmuebles24.com https://img.lamudi.com.mx",
