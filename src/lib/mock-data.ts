...
export const TIJUANA_ZONES: ZoneMetrics[] = [
  ...
  {
    zone_id: "31",
    zone_name: "Buena Vista",
    zone_slug: "buena-vista",
    avg_price_per_m2: 16200,
    price_trend_pct: 2.5,
    avg_ticket: 2200000,
    total_listings: 45,
    listings_by_type: { casa: 12, departamento: 22, terreno: 5, local: 4, oficina: 2 },
    avg_ticket_by_type: { casa: 2800000, departamento: 1800000, terreno: 2500000, local: 1600000, oficina: 1200000 },
  },
  {
    zone_id: "32",
    zone_name: "Chapultepec",
    zone_slug: "chapultepec",
    avg_price_per_m2: 27500,
    price_trend_pct: 3.2,
    avg_ticket: 3900000,
    total_listings: 80,
    listings_by_type: { casa: 30, departamento: 35, terreno: 4, local: 7, oficina: 4 },
    avg_ticket_by_type: { casa: 4800000, departamento: 3100000, terreno: 4500000, local: 3500000, oficina: 2500000 },
  },
  {
    zone_id: "33",
    zone_name: "Hipódromo",
    zone_slug: "hipodromo",
    avg_price_per_m2: 29800,
    price_trend_pct: 3.8,
    avg_ticket: 4200000,
    total_listings: 95,
    listings_by_type: { casa: 35, departamento: 42, terreno: 3, local: 10, oficina: 5 },
    avg_ticket_by_type: { casa: 5200000, departamento: 3300000, terreno: 4900000, local: 3700000, oficina: 2700000 },
  },
  {
    zone_id: "34",
    zone_name: "Residencial del Bosque",
    zone_slug: "residencial-del-bosque",
    avg_price_per_m2: 15500,
    price_trend_pct: 2.0,
    avg_ticket: 2000000,
    total_listings: 42,
    listings_by_type: { casa: 28, departamento: 8, terreno: 3, local: 2, oficina: 1 },
    avg_ticket_by_type: { casa: 2200000, departamento: 1500000, terreno: 2000000, local: 1400000, oficina: 1000000 },
  },
  {
    zone_id: "35",
    zone_name: "Villa Fontana",
    zone_slug: "villa-fontana",
    avg_price_per_m2: 13200,
    price_trend_pct: 1.8,
    avg_ticket: 1700000,
    total_listings: 55,
    listings_by_type: { casa: 35, departamento: 12, terreno: 4, local: 3, oficina: 1 },
    avg_ticket_by_type: { casa: 1800000, departamento: 1200000, terreno: 1900000, local: 1300000, oficina: 900000 },
  },
  // ─── Periférico ────────────────────────────────────────────────────
  {
    zone_id: "29",
