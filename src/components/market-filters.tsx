    ...
    <div ref={panelRef}>
      ...
      {open && (
        <div className="absolute left-0 right-0 z-50 mt-3">
          <div className={`bg-white dark:bg-slate-900 border-2 border-blue-500/40 dark:border-blue-500/30 rounded-2xl shadow-xl shadow-blue-500/10 transition-opacity duration-150 overflow-hidden ${isPending ? "opacity-90" : "opacity-100"}`}>
