...
const TERMS: Term[] = [
  ...
  { id: "inventario", term: "Inventario Activo", icon: "inventory_2", definition: "Nivel cualitativo de actividad basado en la cantidad de propiedades activas en portales inmobiliarios. Se expresa como nivel (bajo, moderado, alto) en vez de número exacto." },
