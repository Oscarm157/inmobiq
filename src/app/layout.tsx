  ...
  return (
    <html lang="es" suppressHydrationWarning>
      <head>
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Bitcount+Single&family=Material+Symbols+Outlined:wght,FILL@100..700,0..1&family=Playfair+Display:ital,wght@0,400;0,700;1,400;1,700&display=swap"
          rel="stylesheet"
        />
      </head>
      <body
